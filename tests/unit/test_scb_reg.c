...
void test_fpu_register_block_size(void) { TEST_ASSERT_EQUAL_UINT(0xC, sizeof(FpuRegisters_t)); }
...
void test_scb_cfsr_fault_status_byte_fields_do_not_overlap(void)
{
  ...
  uint32_t bfsr_bits = SCB_CFSR_IBUSERR | SCB_CFSR_PRECISERR | SCB_CFSR_IMPRECISERR |
                       SCB_CFSR_UNSTKERR | SCB_CFSR_STKERR | SCB_CFSR_LSPERR | SCB_CFSR_BFARVALID;
