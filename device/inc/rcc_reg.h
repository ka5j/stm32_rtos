...
#define RCC_CR_HSION_Pos (0U)                   ///< Bit position of RCC_CR_HSION within RCC_CR
#define RCC_CR_HSION (1U << RCC_CR_HSION_Pos)   ///< WRITE
#define RCC_CR_HSIRDY_Pos (1U)                  ///< Bit position of RCC_CR_HSIRDY within RCC_CR
#define RCC_CR_HSIRDY (1U << RCC_CR_HSIRDY_Pos) ///< READ only
#define RCC_CR_HSEON_Pos (16U)                  ///< Bit position of RCC_CR_HSEON within RCC_CR
#define RCC_CR_HSEON (1U << RCC_CR_HSEON_Pos)   ///< WRITE
#define RCC_CR_HSERDY_Pos (17U)                 ///< Bit position of RCC_CR_HSERDY within RCC_CR
#define RCC_CR_HSERDY (1U << RCC_CR_HSERDY_Pos) ///< READ only
#define RCC_CR_HSEBYP_Pos (18U)                 ///< Bit position of RCC_CR_HSEBYP within RCC_CR
#define RCC_CR_HSEBYP (1U << RCC_CR_HSEBYP_Pos) ///< WRITE, set before HSEON
#define RCC_CR_CSSON_Pos (19U)                  ///< Bit position of RCC_CR_CSSON within RCC_CR
#define RCC_CR_CSSON (1U << RCC_CR_CSSON_Pos)   ///< WRITE, clock security system on HSE
#define RCC_CR_PLLON_Pos (24U)                  ///< Bit position of RCC_CR_PLLON within RCC_CR
#define RCC_CR_PLLON (1U << RCC_CR_PLLON_Pos)   ///< WRITE, after PLLCFGR is set
#define RCC_CR_PLLRDY_Pos (25U)                 ///< Bit position of RCC_CR_PLLRDY within RCC_CR
#define RCC_CR_PLLRDY (1U << RCC_CR_PLLRDY_Pos) ///< READ only

/* --- RCC_CIR bit definitions --- */
#define RCC_CIR_CSSF_Pos (7U)                 ///< Bit position of RCC_CIR_CSSF within RCC_CIR
#define RCC_CIR_CSSF (1U << RCC_CIR_CSSF_Pos) ///< READ only - clock security system failure flag
#define RCC_CIR_CSSC_Pos (23U)                ///< Bit position of RCC_CIR_CSSC within RCC_CIR
#define RCC_CIR_CSSC (1U << RCC_CIR_CSSC_Pos) ///< WRITE 1 to clear CSSF

/* --- RCC_PLLCFGR bit definitions --- */
#define RCC_PLLCFGR_PLLM_Pos (0U) ///< Bit position of RCC_PLLCFGR_PLLM within RCC_PLLCFGR
#define RCC_PLLCFGR_PLLM_Msk (0x3FU << RCC_PLLCFGR_PLLM_Pos) ///< bits 5:0

#define RCC_PLLCFGR_PLLN_Pos (6U) ///< Bit position of RCC_PLLCFGR_PLLN within RCC_PLLCFGR
#define RCC_PLLCFGR_PLLN_Msk (0x1FFU << RCC_PLLCFGR_PLLN_Pos) ///< bits 14:6

#define RCC_PLLCFGR_PLLP_Pos (16U) ///< Bit position of RCC_PLLCFGR_PLLP within RCC_PLLCFGR
#define RCC_PLLCFGR_PLLP_Msk (0x3U << RCC_PLLCFGR_PLLP_Pos) ///< bits 17:16

#define RCC_PLLCFGR_PLLSRC_Pos (22U) ///< Bit position of RCC_PLLCFGR_PLLSRC within RCC_PLLCFGR
#define RCC_PLLCFGR_PLLSRC (1U << RCC_PLLCFGR_PLLSRC_Pos) ///< 0=HSI, 1=HSE

/* --- RCC_CFGR bit definitions --- */
#define RCC_CFGR_SW_Pos (0U)                      ///< Bit position of RCC_CFGR_SW within RCC_CFGR
#define RCC_CFGR_SW_Msk (0x3U << RCC_CFGR_SW_Pos) ///< bits 1:0, system clock switch

#define RCC_CFGR_SWS_Pos (2U) ///< Bit position of RCC_CFGR_SWS within RCC_CFGR
#define RCC_CFGR_SWS_Msk (0x3U << RCC_CFGR_SWS_Pos) ///< bits 3:2, system clock switch status

#define RCC_CFGR_HPRE_Pos (4U) ///< Bit position of RCC_CFGR_HPRE within RCC_CFGR
#define RCC_CFGR_HPRE_Msk (0xFU << RCC_CFGR_HPRE_Pos) ///< bits 7:4, AHB prescaler

#define RCC_CFGR_PPRE1_Pos (10U) ///< Bit position of RCC_CFGR_PPRE1 within RCC_CFGR
#define RCC_CFGR_PPRE1_Msk (0x7U << RCC_CFGR_PPRE1_Pos) ///< bits 12:10, APB1 prescaler

#define RCC_CFGR_PPRE2_Pos (13U) ///< Bit position of RCC_CFGR_PPRE2 within RCC_CFGR
...
#define RCC_AHB1RSTR_GPIOARST_Pos                                                                  \
  (0U) ///< Bit position of RCC_AHB1RSTR_GPIOARST within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOARST                                                                      \
  (1U << RCC_AHB1RSTR_GPIOARST_Pos) ///< GPIOARST bit within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOBRST_Pos                                                                  \
  (1U) ///< Bit position of RCC_AHB1RSTR_GPIOBRST within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOBRST                                                                      \
  (1U << RCC_AHB1RSTR_GPIOBRST_Pos) ///< GPIOBRST bit within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOCRST_Pos                                                                  \
  (2U) ///< Bit position of RCC_AHB1RSTR_GPIOCRST within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOCRST                                                                      \
  (1U << RCC_AHB1RSTR_GPIOCRST_Pos) ///< GPIOCRST bit within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIODRST_Pos                                                                  \
  (3U) ///< Bit position of RCC_AHB1RSTR_GPIODRST within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIODRST                                                                      \
  (1U << RCC_AHB1RSTR_GPIODRST_Pos) ///< GPIODRST bit within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOERST_Pos                                                                  \
  (4U) ///< Bit position of RCC_AHB1RSTR_GPIOERST within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOERST                                                                      \
  (1U << RCC_AHB1RSTR_GPIOERST_Pos) ///< GPIOERST bit within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOFRST_Pos                                                                  \
  (5U) ///< Bit position of RCC_AHB1RSTR_GPIOFRST within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOFRST                                                                      \
  (1U << RCC_AHB1RSTR_GPIOFRST_Pos) ///< GPIOFRST bit within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOGRST_Pos                                                                  \
  (6U) ///< Bit position of RCC_AHB1RSTR_GPIOGRST within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOGRST                                                                      \
  (1U << RCC_AHB1RSTR_GPIOGRST_Pos) ///< GPIOGRST bit within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOHRST_Pos                                                                  \
  (7U) ///< Bit position of RCC_AHB1RSTR_GPIOHRST within RCC_AHB1RSTR
#define RCC_AHB1RSTR_GPIOHRST                                                                      \
  (1U << RCC_AHB1RSTR_GPIOHRST_Pos) ///< GPIOHRST bit within RCC_AHB1RSTR

/* --- RCC_AHB1ENR bit definitions --- */
#define RCC_AHB1ENR_GPIOAEN_Pos (0U) ///< Bit position of RCC_AHB1ENR_GPIOAEN within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOAEN (1U << RCC_AHB1ENR_GPIOAEN_Pos) ///< GPIOAEN bit within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOBEN_Pos (1U) ///< Bit position of RCC_AHB1ENR_GPIOBEN within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOBEN (1U << RCC_AHB1ENR_GPIOBEN_Pos) ///< GPIOBEN bit within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOCEN_Pos (2U) ///< Bit position of RCC_AHB1ENR_GPIOCEN within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOCEN (1U << RCC_AHB1ENR_GPIOCEN_Pos) ///< GPIOCEN bit within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIODEN_Pos (3U) ///< Bit position of RCC_AHB1ENR_GPIODEN within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIODEN (1U << RCC_AHB1ENR_GPIODEN_Pos) ///< GPIODEN bit within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOEEN_Pos (4U) ///< Bit position of RCC_AHB1ENR_GPIOEEN within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOEEN (1U << RCC_AHB1ENR_GPIOEEN_Pos) ///< GPIOEEN bit within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOFEN_Pos (5U) ///< Bit position of RCC_AHB1ENR_GPIOFEN within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOFEN (1U << RCC_AHB1ENR_GPIOFEN_Pos) ///< GPIOFEN bit within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOGEN_Pos (6U) ///< Bit position of RCC_AHB1ENR_GPIOGEN within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOGEN (1U << RCC_AHB1ENR_GPIOGEN_Pos) ///< GPIOGEN bit within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOHEN_Pos (7U) ///< Bit position of RCC_AHB1ENR_GPIOHEN within RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOHEN (1U << RCC_AHB1ENR_GPIOHEN_Pos) ///< GPIOHEN bit within RCC_AHB1ENR

/* --- RCC_APB1RSTR bit definitions --- */
#define RCC_APB1RSTR_USART2RST_Pos                                                                 \
  (17U) ///< Bit position of RCC_APB1RSTR_USART2RST within RCC_APB1RSTR
#define RCC_APB1RSTR_USART2RST                                                                     \
  (1U << RCC_APB1RSTR_USART2RST_Pos) ///< USART2RST bit within RCC_APB1RSTR

/* --- RCC_APB1ENR bit definitions --- */
#define RCC_APB1ENR_USART2EN_Pos (17U) ///< Bit position of RCC_APB1ENR_USART2EN within RCC_APB1ENR
#define RCC_APB1ENR_USART2EN (1U << RCC_APB1ENR_USART2EN_Pos) ///< USART2EN bit within RCC_APB1ENR

/* --- RCC_CSR bit definitions --- */
#define RCC_CSR_LSION_Pos (0U)                    ///< Bit position of RCC_CSR_LSION within RCC_CSR
#define RCC_CSR_LSION (1U << RCC_CSR_LSION_Pos)   ///< WRITE
#define RCC_CSR_LSIRDY_Pos (1U)                   ///< Bit position of RCC_CSR_LSIRDY within RCC_CSR
#define RCC_CSR_LSIRDY (1U << RCC_CSR_LSIRDY_Pos) ///< READ only

#define RCC_CSR_RMVF_Pos (24U)                ///< Bit position of RCC_CSR_RMVF within RCC_CSR
#define RCC_CSR_RMVF (1U << RCC_CSR_RMVF_Pos) ///< WRITE 1 to clear all reset flags below
#define RCC_CSR_BORRSTF_Pos (25U)             ///< Bit position of RCC_CSR_BORRSTF within RCC_CSR
#define RCC_CSR_BORRSTF (1U << RCC_CSR_BORRSTF_Pos) ///< READ only - brown-out reset flag
#define RCC_CSR_PINRSTF_Pos (26U) ///< Bit position of RCC_CSR_PINRSTF within RCC_CSR
#define RCC_CSR_PINRSTF (1U << RCC_CSR_PINRSTF_Pos) ///< READ only - NRST pin reset flag
#define RCC_CSR_PORRSTF_Pos (27U) ///< Bit position of RCC_CSR_PORRSTF within RCC_CSR
#define RCC_CSR_PORRSTF (1U << RCC_CSR_PORRSTF_Pos) ///< READ only - power-on reset flag
#define RCC_CSR_SFTRSTF_Pos (28U) ///< Bit position of RCC_CSR_SFTRSTF within RCC_CSR
#define RCC_CSR_SFTRSTF (1U << RCC_CSR_SFTRSTF_Pos) ///< READ only - software reset flag
#define RCC_CSR_IWDGRSTF_Pos (29U) ///< Bit position of RCC_CSR_IWDGRSTF within RCC_CSR
#define RCC_CSR_IWDGRSTF                                                                           \
  (1U << RCC_CSR_IWDGRSTF_Pos)     ///< READ only - independent watchdog reset flag
#define RCC_CSR_WWDGRSTF_Pos (30U) ///< Bit position of RCC_CSR_WWDGRSTF within RCC_CSR
#define RCC_CSR_WWDGRSTF (1U << RCC_CSR_WWDGRSTF_Pos) ///< READ only - window watchdog reset flag
#define RCC_CSR_LPWRRSTF_Pos (31U) ///< Bit position of RCC_CSR_LPWRRSTF within RCC_CSR
